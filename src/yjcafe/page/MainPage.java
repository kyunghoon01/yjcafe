...
import yjcafe.frame.NoticeContent;
...
public class MainPage extends Page {
	...
	public void onMount(Object param) {
		String u_name = YJCafe.getUser().getU_name();
	...
	class Display extends JPanel { // 메인 패널
		...
		public Display() {
			...
			logo_img = new JLabel(new ImageIcon("yjcafe_1.png"));
			...
			button_mypage.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					param.u_id = YJCafe.getUser().getU_id();
					YJCafe.route("mypage", param);
				}
			});
