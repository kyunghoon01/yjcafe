...
public class CoffeeSubVO {
	...
	CoffeeSubVO(String r_name, int r_coffee_number, int r_max_personnel, int r_area_size, int r_cost, int r_number) {
		this.r_name = r_name;
		this.r_coffee_number = r_coffee_number;
	...
	public int getR_coffee_number() {
		return r_coffee_number;
	}

	public void setR_coffee_number(int r_coffee_number) {
		this.r_coffee_number = r_coffee_number;
	}
